...
public final class Condition {
     ...
     *
     * @param exceptionMessage The message of the exception, which should be thrown, as a {@link
     *                         String} or null, if the exception should not have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, as an
     ...
     *
     * @param expression       The boolean expression, which should be checked, as a {@link Boolean}
     *                         value
     * @param exceptionMessage The message of the exception, which is thrown, if the given boolean
     *                         expression is not true, as a {@link String} or null, if the exception
     ...
     *                         expression is not true, as a {@link String} or null, if the exception
     *                         should not have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         given boolean expression is not true, as an instance of the class
     ...
     *                         value
     * @param exceptionMessage The message of the exception, which is thrown, if the given boolean
     *                         expression is not false, as a {@link String} or null, if the
     *                         exception should not have a message
     */
     ...
     *                         exception should not have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         given boolean expression is not false, as an instance of the class
     *                         {@link Class}. The class may not be null
     */
    public static void ensureFalse(final boolean expression,
                                   @Nullable final String exceptionMessage,
     ...
     * @param exceptionMessage The message of the exception, which is thrown, if the given objects
     *                         are not equal, as a {@link String} or null, if the exception should
     *                         not have a message
     */
     ...
     *                         not have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         objects are not equal, as an instance of the class {@link Class}. The
     ...
     * @param object2          The second object as an instance of the class {@link Object}
     * @param exceptionMessage The message of the exception, which is thrown, if the given objects
     *                         are equal, as a {@link String} or null, if the exception should not
     *                         have a message
     */
     ...
     *                         have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         objects are equal, as an instance of the class {@link Class}. The
     *                         class may not be null
     */
    public static void ensureNotEqual(final Object object1, final Object object2,
                                      @Nullable final String exceptionMessage,
     ...
     * message is thrown.
     *
     * @param object           The object, which should be checked, as an instance of the class
     *                         {@link Object}
     * @param exceptionMessage The message of the exception, which is thrown, if the given object is
     *                         null, as a {@link String} or null, if the exception should not have a
     *                         message
     */
     ...
     *                         message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         given object is null, as an instance of the class {@link Class}. The
     *                         class may not be null
     */
    public static void ensureNotNull(final Object object, @Nullable final String exceptionMessage,
                                     @NotNull final Class<? extends RuntimeException> exceptionClass) {
     ...
     *
     * @param text             The text, which should be checked, as an instance of the type {@link
     *                         CharSequence}
     * @param exceptionMessage The message of the exception, which is thrown, if the given text is
     *                         empty, as a {@link String} or null, if the exception should not have
     *                         a message
     */
     ...
     *                         a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         given text is empty, as an instance of the class {@link Class}. The
     *                         class may not be null
     */
    public static void ensureNotEmpty(final CharSequence text,
                                      @Nullable final String exceptionMessage,
     ...
     * @param referenceValue   The reference value, the given value must be at least as great as, as
     *                         a {@link Short} value
     * @param exceptionMessage The message of the exception, which is thrown, if the given value is
     *                         smaller as the reference value, as a {@link String} or null, if the
     *                         exception should not have a message
     */
     ...
     *                         exception should not have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         given value is smaller as the reference value, as an instance of the
     ...
     *
     * @param value            The value, which should be checked, as a {@link Short} value
     * @param referenceValue   The reference value, the given value must be at maximum as great as,
     *                         as a {@link Short} value
     * @param exceptionMessage The message of the exception, which is thrown, if the given value is
     *                         greater as the reference value, as a {@link String} or null, if the
     *                         exception should not have a message
     */
     ...
     *                         exception should not have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         given value is greater as the reference value, as an instance of the
     *                         class {@link Class}. The class may not be null
     */
    public static void ensureAtMaximum(final short value, final short referenceValue,
                                       @Nullable final String exceptionMessage,
     ...
     *
     * @param value            The value, which should be checked, as a {@link Short} value
     * @param referenceValue   The reference value, the given value must be greater as, as a {@link
     *                         Short} value
     * @param exceptionMessage The message of the exception, which is thrown, if the given value is
     *                         smaller or equal as the reference value, as a {@link String} or null,
     *                         if the exception should not have a message
     */
     ...
     *                         if the exception should not have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         given value is smaller or equal as the reference value, as an
     *                         instance of the class {@link Class}. The class may not be null
     */
    public static void ensureGreater(final short value, final short referenceValue,
                                     @Nullable final String exceptionMessage,
     ...
     *
     * @param value            The value, which should be checked, as an {@link Integer} value
     * @param referenceValue   The reference value, the given value must be greater as, as an {@link
     *                         Integer} value
     * @param exceptionMessage The message of the exception, which is thrown, if the given value is
     *                         smaller or equal as the reference value, as a {@link String} or null,
     *                         if the exception should not have a message
     ...
     *
     * @param value            The value, which should be checked, as a {@link Short} value
     * @param referenceValue   The reference value, the given value must be smaller as, as a {@link
     *                         Short} value
     * @param exceptionMessage The message of the exception, which is thrown, if the given value is
     *                         greater or equal as the reference value, as a {@link String} or null,
     *                         if the exception should not have a message
     */
     ...
     *                         if the exception should not have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         given value is greater or equal as the reference value, as an
     *                         instance of the class {@link Class}. The class may not be null
     */
    public static void ensureSmaller(final short value, final short referenceValue,
                                     @Nullable final String exceptionMessage,
     ...
     *
     * @param value            The value, which should be checked, as an {@link Integer} value
     * @param referenceValue   The reference value, the given value must be smaller as, as an {@link
     *                         Integer} value
     * @param exceptionMessage The message of the exception, which is thrown, if the given value is
     *                         greater or equal as the reference value, as a {@link String} or null,
     *                         if the exception should not have a message
     ...
     *
     * @param iterable         The iterable, which should be checked, as an instance of the type
     *                         {@link Iterable}
     * @param exceptionMessage The message of the exception, which is thrown, if the given iterable
     *                         is empty, as a {@link String} or null, if the exception should not
     *                         have a message
     */
     ...
     *                         have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         given iterable is empty, as an instance of hte class {@link Class}.
     ...
     * specific message is thrown.
     *
     * @param file             The file, which should be checked, as an instance of the class {@link
     *                         File}. The file may not be null
     * @param exceptionMessage The message of the exception, which is thrown, if the given file does
     *                         not exist, as a {@link String} or null, if the exception should not
     *                         have a message
     */
     ...
     *                         have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         given file does not exist, as an instance of the class {@link Class}.
     *                         The class may not be null
     */
    public static void ensureFileExists(@NotNull final File file,
                                        @Nullable final String exceptionMessage,
                                        @NotNull final Class<? extends RuntimeException> exceptionClass) {
        if (!file.exists()) {
            throwException(exceptionMessage, exceptionClass);
     ...
     * @param file             The file, which should be checked, as an instance of the class {@link
     *                         File}. The file may not be null
     * @param exceptionMessage The message of the exception, which is thrown, if the given file is
     *                         not a directory, as a {@link String} or null, if the exception should
     *                         not have a message
     */
    public static void ensureFileIsDirectory(@NotNull final File file,
                                             @Nullable final String exceptionMessage) {
     ...
     *                         not have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         given file is not a directory, as an instance of the class {@link
     ...
     * @param file             The file, which should be checked, as an instance of the class {@link
     *                         File}. The file may not be null
     * @param exceptionMessage The message of the exception, which is thrown, if the given file is a
     *                         directory or does not exist, as a {@link String} or null, if the
     *                         exception should not have a message
     */
    public static void ensureFileIsNoDirectory(@NotNull final File file,
                                               @Nullable final String exceptionMessage) {
     ...
     *                         exception should not have a message
     * @param exceptionClass   The class of the runtime exception, which should be thrown, if the
     *                         given file is a directory or does not exist, as an instance of the
     *                         class {@link Class}. The class may not be null
     */
    public static void ensureFileIsNoDirectory(@NotNull final File file,
                                               @Nullable final String exceptionMessage,
